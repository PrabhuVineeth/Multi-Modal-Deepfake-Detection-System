...
<span style="color:{NEON['yellow']};">VIDEO INPUT</span>
  ...
  └─ <span style="color:{NEON['lime']};">OUTPUT</span>
    ...
    st.markdown(
        ...
        f'<div class="brutal-card"><div className="card-title" style="font-weight:700; color:{NEON["cyan"]}; margin-bottom:0.5rem;">Confidence Calibration ECE</div><div style="font-size:0.85rem; color:{NEON["white"]};">The calibrated temperature-scaled model reports an ECE of <strong>0.1579</strong> (a 53.6% improvement), verifying that confidence levels align with true correctness rates.</div></div>'
        f'<div class="brutal-card"><div className="card-title" style="font-weight:700; color:{NEON["magenta"]}; margin-bottom:0.5rem;">Equal Error Rate (EER)</div><div style="font-size:0.85rem; color:{NEON["white"]};">The calibrated joint model achieves an EER of <strong>5.80%</strong>, providing robust protection for deepfake defense operations.</div></div></div>',
        unsafe_allow_html=True,
    )
    st.markdown(
        f'<table class="brutal-table"><thead><tr><th>Dataset</th><th>Modalities</th><th>Samples</th><th>Best AUC</th><th>Accuracy</th><th>F1-Score</th><th>Threshold</th></tr></thead><tbody><tr><td><span style="color:{NEON["cyan"]}; font-weight:700;">FakeAVCeleb</span></td><td>Audio + Video</td><td>21,566</td><td><span style="color:{NEON["lime"]};">0.913</span></td><td>94.1%</td><td>0.845</td><td>T=0.96</td></tr><tr><td><span style="color:{NEON["magenta"]}; font-weight:700;">FaceForensics++</span></td><td>Video only</td><td>7,000</td><td><span style="color:{NEON["lime"]};">0.753</span></td><td>67.5%</td><td>0.733</td><td>T=0.52</td></tr><tr><td><span style="color:{NEON["yellow"]}; font-weight:700;">LAV-DF</span></td><td>Audio + Video</td><td>36,431</td><td><span style="color:{NEON["lime"]};">0.806</span></td><td>85.2%</td><td>0.901</td><td>T=0.44</td></tr><tr style="background:{NEON["surface2"]};"><td><span style="color:{NEON["lime"]}; font-weight:700;">Combined (Joint)</span></td><td>Audio + Video</td><td>28,566</td><td><span style="color:{NEON["lime"]}; font-weight:900;">0.952</span></td><td><span style="font-weight:700;">91.2%</span></td><td><span style="font-weight:700;">0.928</span></td><td>T=0.50</td></tr></tbody></table>',
        unsafe_allow_html=True,
    )
