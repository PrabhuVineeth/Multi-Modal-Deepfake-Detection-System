...
class CrossAttentionLayer(nn.Module):
    ...
    def forward(
        ...
        """
        # Force MultiheadAttention dot-product to run in weight dtype to prevent FP16 overflow/NaN under AMP
        dtype = self.attention.in_proj_weight.dtype if hasattr(self.attention, "in_proj_weight") and self.attention.in_proj_weight is not None else query.dtype
